...
for (let i = 0; i < data.nofilter_highschool_ratings.length; i++) {
  arr.push({
    id: data.nofilter_highschool_ratings[i].nofilter_highschool_id,
    name: data.nofilter_highschool_ratings[i].name,
    score: data.nofilter_highschool_ratings[i].average_score,
  });
}
var arr2 = [];
for (let i = 0; i < data2.posts.length; i++) {
  arr2.push({
    name: data2.posts[i].name,
    subject: data2.posts[i].subject,
    content: data2.posts[i].content,
    view: data2.posts[i].view,
    recommend: data2.posts[i].recommend,
    comment: data2.posts[i].comment,
    updated_at: data2.posts[i].updated_at,
  });
}
